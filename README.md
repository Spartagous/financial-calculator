...
<li>Transaction Ledger: See a list of all transactions, and see individual account transactions. Transactions don't delete when accounts are removed. Automatically detect duplicate transactions when a new account is added</li>
</ul>
